...
describe(harness.getCommandLineArgs().appType + ':' + harness.getCommandLineArgs().appSubType +
    ...
    OneStop.pageLicensingLineLevelChanges(false, harness.getCommandLineArgs().appType, '', null);
    OneStop.pageLicenseAmendmentTechnicalInformation(false, 'Y', null, 'Y', null, null, null, null, null, null, null);
