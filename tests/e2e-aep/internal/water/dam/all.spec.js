/**
 * Created by cb7yb on 5/09/2018.
 * Preconditions:
 * - npm run e2e-aep:application:water-dam -- --env=dev-aep
 * Then:
 * - npm run e2e-aep:internal:water-dam -- --env=dev-aep
 */
...
describe(harness.getCommandLineArgs().appType + ':' + harness.getCommandLineArgs().appSubType +
    ...
    OneStop.actionVerifyLicensePDF(80000);
});
