...
describe(harness.getCommandLineArgs().appType + ':' + harness.getCommandLineArgs().appSubType +
    ...
    describe('reports launch', () => {
        describe('navigate to reports page', () => {
            OneStop.clickRightSideTopLinks('a[data-event="show:tableau:home"]');
            ...
            it('opens a new tab to correct url', async () => {
                ...
                const expectedUrl = configJson.tableauBaseInternalUrl + '/';
        ...
        for (let i = 0; i < reportsArray.length; i++) {
            OneStop.openReportDocuments(configJson.tableauBaseInternalUrl, reportsArray, i);
        }
    });
});
